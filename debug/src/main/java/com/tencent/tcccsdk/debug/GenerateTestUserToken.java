package com.tencent.tcccsdk.debug;
...
public class GenerateTestUserToken {
     ...
     * 呼叫的号码
     */
    public static final String TO = "075536564058";
     ...
     */
    public static String genTestUserSig(String secretId, String secretKey,long sdkAppId, String userId, UserTokenCallBack callBack) {
        return GenTLSSignature(secretId, secretKey,sdkAppId, userId,callBack);
    }


    private static String GenTLSSignature(String secretId, String secretKey, long sdkAppId, String userId, UserTokenCallBack callBack)  {
